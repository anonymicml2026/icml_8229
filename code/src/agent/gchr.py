...
class GCHR(Agent):
    def __init__(self, args, env):
        ...
        self.sample_gchr_transitions =  self.sampler.sample_gchr_transitions

        def sample_func(S, A, AG,  G, size):
            return self.sample_gchr_transitions(
                    S, A, AG, G, size)
    ...
    def train_prior_policy(self, A,S,G):
