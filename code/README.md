#  gchr: Goal-conditioned Reinforcement Learning with Hindsight Regularizations

This repo contains the official implementation for gchr.

## 1. Dependencies
Create conda environment.
```
conda create -n gchr python=3.7.4
conda activate gchr
```
Install PyTorch
```
...
```
Goal-conditioned Reinforcement Learning with Hindsight Regularizations
 └─run_gchr.sh     (the script to run with a specific critic architecture)
